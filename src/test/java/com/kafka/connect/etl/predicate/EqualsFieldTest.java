package com.kafka.connect.etl.predicate;

import com.kafka.connect.etl.predicates.EqualsField;
...
public class EqualsFieldTest {
    ...
    private static final String RECORD_NAME = "com.kafka.connect.etl.Record";
